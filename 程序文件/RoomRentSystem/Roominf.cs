    ...
    public partial class Roominf : Form
    {
        ...
        private void Roominf_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                roomdataGridView.Columns["num"].HeaderText = "设备编号";
                roomdataGridView.Columns["weizhi"].HeaderText = "设备区域";
                roomdataGridView.Columns["mingzi"].HeaderText = "设备名称";
                roomdataGridView.Columns["zhonglei"].HeaderText = "设备类型";
                roomdataGridView.Columns["mianji"].HeaderText = "占地面积";
                roomdataGridView.Columns["zhuangxiu"].HeaderText = "保养状况";
                roomdataGridView.Columns["sheshi"].HeaderText = "设备功能";
                roomdataGridView.Columns["yongtu"].HeaderText = "设备所属";
                roomdataGridView.Columns["jiage"].HeaderText = "价格";
                roomdataGridView.Columns["zhuangtai"].HeaderText = "设备状态";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (comboBox1.SelectedItem.ToString().Equals("设备编号"))
                    chaxunfangshi = "num";
                else if (comboBox1.SelectedItem.ToString().Equals("设备区域"))
                    chaxunfangshi = "weizhi";
                else if (comboBox1.SelectedItem.ToString().Equals("设备名称"))
                    chaxunfangshi = "mingzi";
                else if (comboBox1.SelectedItem.ToString().Equals("设备状态"))
